...
class FeedSearchDialog(context: Context, private val defaultFeeds: List<SearchFeedResult> = generateDefaultFeeds(context)) : SimpleSearchDialogCompat<SearchFeedResult>(context, context.getString(R.string.feed_search),
		context.getString(R.string.feed_search_hint), null, ArrayList(defaultFeeds),
		...
		val apiFilter = object : BaseFilter<SearchFeedResult>() {
			...
			override fun publishResults(charSequence: CharSequence, filterResults: FilterResults?) {
				filterResults?.let {
					...
					filterResultListener.onFilter(it.values as ArrayList<SearchFeedResult>)
				}
				doAfterFiltering()
			}
		}
